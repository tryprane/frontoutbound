    ...
    <div className="landing-page">
      ...
      <div className="landing-nav-pill-wrapper">
        <nav className="landing-nav-pill">
          <BrandLogo href="/" size="md" className="scale-90 origin-left sm:scale-100" />
          ...
          <div className="flex items-center gap-3 sm:gap-8">
            ...
            <div className="flex items-center gap-2 sm:gap-3 shrink-0">
              ...
              <Link href="#pricing" className="uneevo-btn-red !py-2 !px-3.5 sm:!py-2.5 sm:!px-5 text-xs sm:text-sm whitespace-nowrap">
                <span className="hidden sm:inline">Claim Batch Seat</span>
      ...
      <section className="relative pt-12 sm:pt-16 pb-8 sm:pb-10 px-4 sm:px-6 md:px-8 max-w-6xl mx-auto text-center z-10">
        <div className="hero-gradient-glow" />

        {/* Platform Status Badge */}
        <div className="inline-flex items-center mb-4 max-w-full">
          <div className="batch-pill text-xs py-1 px-3 max-w-full truncate">
            <span className="batch-pill-dot shrink-0" />
            <span className="hidden sm:inline">High Deliverability Outbound Infrastructure • </span>
            <span>Active Platform</span>
          </div>
        </div>

        {/* Headline stating concrete outcome (Point 1) */}
        <h1 className="zoho-puvi-headline text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-[#121316] max-w-5xl mx-auto mb-4 tracking-tight break-words">
        ...
        {/* Action Buttons */}
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4 mb-8 w-full sm:w-auto px-2 sm:px-0">
          <Link href="#pricing" className="uneevo-btn-red text-sm sm:text-base px-6 sm:px-8 py-3.5 w-full sm:w-auto">
            <span>Get Started for ₹999/mo</span>
            <ArrowRight className="w-4 h-4" />
          </Link>
          <a href="#comparison" className="uneevo-btn-secondary text-sm sm:text-base px-6 sm:px-8 py-3.5 w-full sm:w-auto">
            <span>See Stack Cost Breakdown</span>
          </a>
        </div>

        {/* Live Beta Proof Ticker (Point 2) */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5 sm:gap-4 max-w-4xl mx-auto pt-4 border-t border-[#121316]/10 text-left">
          <div className="p-2.5 sm:p-3">
            <div className="text-xl sm:text-2xl md:text-3xl font-extrabold text-[#121316]">142,800+</div>
            <div className="text-[11px] sm:text-xs text-[#62605c] font-medium mt-1">Emails Sent in Beta</div>
          </div>
          <div className="p-2.5 sm:p-3">
            <div className="text-xl sm:text-2xl md:text-3xl font-extrabold text-[#ee382b]">4.8%</div>
            <div className="text-[11px] sm:text-xs text-[#62605c] font-medium mt-1">Average Reply Rate</div>
          </div>
          <div className="p-2.5 sm:p-3">
            <div className="text-xl sm:text-2xl md:text-3xl font-extrabold text-[#121316]">99.1%</div>
            <div className="text-[11px] sm:text-xs text-[#62605c] font-medium mt-1">Primary Inbox Placement</div>
          </div>
          <div className="p-2.5 sm:p-3">
            <div className="text-xl sm:text-2xl md:text-3xl font-extrabold text-[#121316]">32</div>
            <div className="text-[11px] sm:text-xs text-[#62605c] font-medium mt-1">Active Agency Partners</div>
          </div>
        </div>

        {/* Interactive Hero Tab Mockup Showcase */}
        <div className="mt-8 uneevo-card p-3 sm:p-4 md:p-5 text-left">
          {/* Tab Selector */}
          <div className="flex items-center gap-2 overflow-x-auto pb-3 mb-4 border-b border-[#121316]/10 no-scrollbar">
            <button
              onClick={() => setActiveHeroTab('campaigns')}
              className={`shrink-0 whitespace-nowrap px-3.5 py-2 rounded-xl text-xs md:text-sm font-semibold transition-all flex items-center gap-2 ${
          ...
          <div className="bg-[#faf8f4] border border-[#121316]/10 rounded-2xl p-3.5 sm:p-5 md:p-6 min-h-[280px]">
            {activeHeroTab === 'campaigns' && (
              <div>
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
                  <div>
                    <h4 className="font-bold text-[#121316] text-sm sm:text-base">Q3 B2B Outbound Campaign</h4>
                    <p className="text-xs text-[#62605c]">Sequence active across 4 rotated mailboxes • 1,420 leads loaded</p>
                  </div>
                  <span className="self-start sm:self-auto px-3 py-1 bg-[#0f8a5f]/10 text-[#0f8a5f] text-xs font-bold rounded-full border border-[#0f8a5f]/20 shrink-0">
                    Active • Sending
                  </span>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-4">
                  <div className="bg-white p-3 sm:p-3.5 rounded-xl border border-[#121316]/08">
                    <span className="text-xs text-[#62605c] font-medium block">Sent Mails</span>
                    <strong className="text-lg sm:text-xl font-bold text-[#121316]">1,420 / 2,000</strong>
                  </div>
                  <div className="bg-white p-3 sm:p-3.5 rounded-xl border border-[#121316]/08">
                    <span className="text-xs text-[#62605c] font-medium block">Unique Opens</span>
                    <strong className="text-lg sm:text-xl font-bold text-[#121316]">64.2%</strong>
                  </div>
                  <div className="bg-white p-3 sm:p-3.5 rounded-xl border border-[#121316]/08">
                    <span className="text-xs text-[#62605c] font-medium block">Replied Leads</span>
                    <strong className="text-lg sm:text-xl font-bold text-[#ee382b]">9.4% (133 replies)</strong>
                  </div>
                </div>
                <div className="bg-white p-3 rounded-xl border border-[#121316]/08 flex flex-col sm:flex-row sm:items-center justify-between gap-1.5 text-xs text-[#52504b]">
                  <span>Step 1: &ldquo;Quick question regarding outbound stack...&rdquo;</span>
                  <span className="font-semibold text-[#0f8a5f] shrink-0">64.2% open • 9.4% reply</span>
                </div>
              </div>
            )}
            ...
            {activeHeroTab === 'mailboxes' && (
              <div>
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
                  <div>
                    <h4 className="font-bold text-[#121316] text-sm sm:text-base">Connected Mailbox Inventory</h4>
                    <p className="text-xs text-[#62605c]">Distributed sending capacity across Google Workspace & Microsoft 365</p>
                  </div>
                  <span className="self-start sm:self-auto px-3 py-1 bg-[#121316] text-white text-xs font-bold rounded-full shrink-0">
                    8 Accounts Connected
                  </span>
                </div>
                <div className="space-y-2">
                  <div className="bg-white p-3 rounded-xl border border-[#121316]/08 flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-xs">
                    ...
                    <span className="self-start sm:self-auto px-2.5 py-1 bg-[#0f8a5f]/10 text-[#0f8a5f] font-semibold rounded-md shrink-0">99% Health • SPF Pass</span>
                  </div>
                  <div className="bg-white p-3 rounded-xl border border-[#121316]/08 flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-xs">
                    <div className="flex items-center gap-3 min-w-0">
                    ...
                    <span className="self-start sm:self-auto px-2.5 py-1 bg-[#0f8a5f]/10 text-[#0f8a5f] font-semibold rounded-md shrink-0">98% Health • DKIM Pass</span>
                  </div>
                </div>
              </div>
            )}
            ...
            {activeHeroTab === 'warmup' && (
              <div>
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
                  <div>
                    <h4 className="font-bold text-[#121316] text-sm sm:text-base">Domain Health & Warmup Engine</h4>
                    <p className="text-xs text-[#62605c]">Automated peer exchange & deliverability monitor</p>
                  </div>
                  <span className="self-start sm:self-auto px-3 py-1 bg-[#0f8a5f]/10 text-[#0f8a5f] text-xs font-bold rounded-full shrink-0">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-3 text-xs">
                  <div className="bg-white p-3 rounded-xl border border-[#121316]/08">
                    ...
                    <strong className="text-sm sm:text-base text-[#121316]">420 / day</strong>
                  </div>
                  <div className="bg-white p-3 rounded-xl border border-[#121316]/08">
                    <span className="text-[#62605c] block">Spam Recovery Rate</span>
                    <strong className="text-sm sm:text-base text-[#0f8a5f]">100% Auto-Saved</strong>
                  </div>
                  <div className="bg-white p-3 rounded-xl border border-[#121316]/08">
                    <span className="text-[#62605c] block">DNS Status</span>
                    <strong className="text-sm sm:text-base text-[#121316]">SPF, DKIM, DMARC OK</strong>
                  </div>
                </div>
              </div>
            )}
            ...
            {activeHeroTab === 'replies' && (
              <div>
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
                  <div>
                    <h4 className="font-bold text-[#121316] text-sm sm:text-base">Unified Master Inbox</h4>
                    <p className="text-xs text-[#62605c]">All responses synced in one thread with sentiment tagging</p>
                  </div>
                  <span className="self-start sm:self-auto px-3 py-1 bg-[#ee382b]/10 text-[#ee382b] text-xs font-bold rounded-full shrink-0">
                    14 Leads Replied
                  </span>
                </div>
                <div className="bg-white p-3 rounded-xl border border-[#121316]/08 text-xs space-y-2">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 pb-2 border-b border-[#121316]/08">
                    <span className="font-bold text-[#121316]">John Doe (Stripe)</span>
                    <span className="self-start sm:self-auto px-2 py-0.5 bg-[#0f8a5f]/10 text-[#0f8a5f] font-semibold rounded shrink-0">Positive Reply</span>
                  </div>
      ...
      <section className="py-8 sm:py-10 px-4 sm:px-6 md:px-8 max-w-6xl mx-auto">
        <div className="founder-note-card grid grid-cols-1 lg:grid-cols-12 gap-6 items-start p-4 sm:p-6 md:p-8">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="flex flex-wrap gap-1.5 sm:gap-2 mb-4">
              {[
                ...
                <span
                  key={chip.label}
                  className="inline-flex items-center gap-1.5 px-2.5 sm:px-3 py-1 rounded-full bg-[#121316]/06 border border-[#121316]/10 text-xs font-semibold text-[#52504b]"
                >
        ...
        <div className="mt-7">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-3.5">
            {/* Card 1 */}
            <div className="p-3.5 sm:p-4 rounded-xl border border-[#121316]/10 bg-[#faf8f4]">
      ...
      <section id="how-it-works" className="py-8 sm:py-10 px-4 sm:px-6 md:px-8 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3 mb-6">
          {stepDetails.map((s) => (
            <button
              ...
              className={`p-2.5 sm:p-3.5 text-left rounded-2xl transition-all border ${
                activeStepTab === s.step
                  ? 'bg-[#121316] text-white border-[#121316] shadow-md'
                  : 'bg-white text-[#121316] border-[#121316]/10 hover:bg-[#f5f3ef]'
              }`}
            >
              <div className="text-[11px] sm:text-xs font-bold tracking-wider opacity-70 mb-0.5">STEP 0{s.step}</div>
              <div className="text-xs sm:text-sm font-extrabold truncate">{s.tag.split(' — ')[1]}</div>
            </button>
          ))}
        </div>
        ...
        {stepDetails.map((s) => {
          ...
          return (
            <div key={s.step} className="uneevo-card p-4 sm:p-6 md:p-8 grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
              <div className="lg:col-span-5 space-y-4">
                <span className="px-3 py-1 bg-[#ee382b]/10 text-[#ee382b] text-xs font-bold rounded-full inline-block">
                  {s.tag}
                </span>
                <h3 className="uneevo-serif-headline text-xl sm:text-2xl md:text-3xl text-[#121316] leading-tight">
                  {s.title}
                </h3>
              ...
              {/* UI Mockup Window */}
              <div className="lg:col-span-7 bg-[#faf8f4] border border-[#121316]/10 rounded-2xl p-3.5 sm:p-5 shadow-inner">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 mb-3 border-b border-[#121316]/10">
                  ...
                  <span className="self-start sm:self-auto px-2.5 py-0.5 bg-[#121316] text-white text-[11px] font-bold rounded shrink-0">
                    {s.mockupData.badge}
                  </span>
                </div>
                ...
                <div className="space-y-2">
                  {s.mockupData.items.map((item: any, i: number) => (
                    <div key={i} className="bg-white p-3 rounded-xl border border-[#121316]/08 flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-xs">
                      <div>
      ...
      <section id="comparison" className="py-8 sm:py-10 px-4 sm:px-6 md:px-8 max-w-6xl mx-auto">
        <div className="stack-compare-box">
          <div className="text-center max-w-2xl mx-auto mb-7">
            ...
            <h2 className="uneevo-serif-headline text-2xl sm:text-4xl md:text-5xl text-white mb-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 max-w-4xl mx-auto">
            ...
            <div className="old-stack-col">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 pb-3 mb-3 border-b border-white/10">
                ...
                <span className="text-xl font-extrabold text-[#ee382b] self-start sm:self-auto">$228/mo</span>
              </div>
              <ul className="space-y-2.5 text-xs text-[#d0ceb8]">
                <li className="flex items-start justify-between gap-2">
                  <span>Smartlead / Instantly Plan</span>
                  <span className="font-bold text-white shrink-0">$94/mo</span>
                </li>
                <li className="flex items-start justify-between gap-2">
                  <span>Standalone Warmup Service</span>
                  <span className="font-bold text-white shrink-0">$50/mo</span>
                </li>
                <li className="flex items-start justify-between gap-2">
                  <span>Domain Health & SPF Monitor</span>
                  <span className="font-bold text-white shrink-0">$49/mo</span>
                </li>
                <li className="flex items-start justify-between gap-2">
                  <span>CSV Lead Scrubbing Utility</span>
                  <span className="font-bold text-white shrink-0">$35/mo</span>
                </li>
              </ul>
            </div>
            ...
            <div className="new-stack-col">
              ...
              <ul className="space-y-2.5 text-xs text-white">
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-[#ee382b] mt-0.5 shrink-0" />
      ...
      <section id="pricing" className="py-8 sm:py-10 px-4 sm:px-6 md:px-8 max-w-6xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-7">
          <span className="text-xs font-bold tracking-widest text-[#ee382b] uppercase block mb-2">TRANSPARENT PRICING</span>
          <h2 className="uneevo-serif-headline text-2xl sm:text-4xl md:text-5xl text-[#121316] mb-3">
        ...
        <div className="max-w-xl mx-auto uneevo-card p-4 sm:p-6 md:p-8 relative overflow-hidden border-2 border-[#121316]">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5 pb-5 border-b border-[#121316]/10">
            <div>
            ...
            <div className="text-left sm:text-right">
              <div className="text-3xl sm:text-4xl font-extrabold text-[#121316]">₹999</div>
          ...
          <div className="mb-5">
            ...
            <ul className="space-y-2.5 text-sm text-[#3b3a36]">
              <li className="flex items-start gap-2.5 font-semibold">
                <CheckCircle2 className="w-4 h-4 text-[#0f8a5f] mt-0.5 shrink-0" />
          ...
          <div className="p-3 sm:p-3.5 bg-[#faf8f4] rounded-xl border border-[#121316]/10 mb-5">
            ...
            <ul className="space-y-1.5 text-xs text-[#62605c]">
              <li className="flex items-start gap-2">
                <XCircle className="w-3.5 h-3.5 text-[#ee382b] mt-0.5 shrink-0" />
      ...
      <section id="faq" className="py-8 sm:py-10 px-4 sm:px-6 md:px-8 max-w-4xl mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-7">
        ...
        <div className="space-y-3">
          {faqs.map((faq, index) => (
            <div key={index} className="faq-card p-3.5 sm:p-4 cursor-pointer" onClick={() => toggleFaq(index)}>
              <div className="flex items-start sm:items-center justify-between gap-3">
                <h4 className="font-bold text-[#121316] text-sm md:text-base">{faq.q}</h4>
                <ChevronDown className={`w-4 h-4 text-[#62605c] shrink-0 transition-transform mt-0.5 sm:mt-0 ${activeFaq === index ? 'rotate-180' : ''}`} />
              </div>
              {activeFaq === index && (
      ...
      <section className="py-8 sm:py-10 px-4 sm:px-6 md:px-8 max-w-4xl mx-auto">
        <div className="uneevo-card p-4 sm:p-6 md:p-7">
          <div className="flex items-center gap-2 mb-4">
            <History className="w-4 h-4 text-[#ee382b]" />
            <h3 className="font-bold text-[#121316] text-base sm:text-lg">Recent Product Changelog</h3>
          </div>
      ...
      <footer className="pt-8 sm:pt-10 pb-6 sm:pb-8 px-4 sm:px-6 md:px-8 border-t border-[#121316]/10 bg-[#f5f3ef] overflow-hidden">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 mb-6">
          <BrandLogo href="/" size="md" showTagline={true} className="scale-90 origin-left sm:scale-100" />

          <div className="flex flex-wrap items-center justify-center sm:justify-start gap-4 sm:gap-6 text-xs font-semibold text-[#62605c]">
