...
function HealthBadge({ score }: { score: number }) {
  ...
  return (
    <div className="flex justify-center">
      <div
        className={`h-7.5 inline-flex items-center justify-center px-3 rounded-lg border transition-all ${
          isHealthy
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto flex-wrap">
          ...
          >
            ...
            />
            <span className="text-sm font-semibold">{connectedCount} Active</span>
          </button>
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto flex-wrap">
          ...
          <div className="relative">
            ...
            >
              ...
              <option value="connected">Show: Active ({connectedCount})</option>
              <option value="disconnected">Show: Disabled ({disconnectedCount})</option>
      ...
      <div className="max-w-[1400px] mx-auto bg-white rounded-xl shadow-sm border border-gray-200/80 overflow-hidden">
        {/* Table Header */}
        <div className="grid grid-cols-[2.5fr_1fr_1fr_1fr_1fr_auto] gap-4 px-6 py-3.5 bg-white border-b border-gray-100 text-xs font-semibold text-gray-500 uppercase tracking-wider sticky top-0 z-10">
          <div>Account</div>
          <div>Status</div>
          ...
          {props.loading ? (
            ...
            <div className="px-6 py-12 text-center text-sm text-gray-500 italic">
              {searchQuery
                ...
                : statusFilter === 'disconnected'
                ? 'No disabled mail accounts found.'
                : statusFilter === 'connected'
                ? 'No active mail accounts found.'
              ...
              return (
                ...
                >
                  ...
                  <div
                    ...
                    className="grid grid-cols-[2.5fr_1fr_1fr_1fr_1fr_auto] gap-4 px-6 py-3.5 items-center hover:bg-gray-50/80 cursor-pointer transition-colors group"
                  >
                    {/* Account Info */}
                    <div className="flex items-center gap-3.5 min-w-0">
                      <MailboxAvatar account={account} size="md" />
                      <div className="flex flex-col min-w-0">
                        <div className="flex items-center gap-2 min-w-0">
                          <span className="text-[14px] sm:text-[15px] font-semibold text-gray-900 truncate group-hover:text-emerald-700 transition-colors">
                            {account.email}
                          </span>
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {account.mailboxSyncStatus === 'error' ? (
                        ...
                        <span className="text-xs font-medium text-gray-500 flex items-center gap-1.5">
                          <Check className="h-3.5 w-3.5 text-green-600" /> Synced
                        </span>
                      )}
                    </div>
                    ...
                    <div className="text-center text-sm font-medium text-gray-700">
                      <span className="text-gray-900 font-bold text-[14px]">{account.sentToday}</span>{' '}
                      <span className="text-gray-400 font-normal text-xs">/{account.dailyLimit}</span>
                    </div>

                    {/* Warmup */}
                    <div className="text-center text-sm font-medium text-gray-700">
                      <span className="text-gray-900 font-bold text-[14px]">{account.warmupSentToday}</span>{' '}
                      <span className="text-gray-400 font-normal text-xs">/{account.warmupDailyLimit}</span>
                    </div>
